...
Verify Tenant {{ tenant.name }} Faults
    ...
    ${critical}=   Get Value From Json   ${r}   $..faultCountsWithDetails.attributes.crit
    ${major}=   Get Value From Json   ${r}   $..faultCountsWithDetails.attributes.maj
    ${minor}=   Get Value From Json   ${r}   $..faultCountsWithDetails.attributes.minor
...
Verify Tenant {{ tenant.name }} Health
    ...
    Set Suite Variable   $r   ${r.json()}
    ${health}=   Get Value From Json   ${r}   $..healthInst.attributes.cur

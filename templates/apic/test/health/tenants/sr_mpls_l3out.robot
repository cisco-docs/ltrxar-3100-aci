...
{% if out.expected_state.maximum_major_faults is defined %}
    Run Keyword If   ${major} > {{ out.expected_state.maximum_major_faults }}   Run Keyword And Continue On Failure
    ...   Fail  "{{ l3out_name }} has ${major} major faults"
{% endif %}
{% if out.expected_state.maximum_minor_faults is defined %}
    Run Keyword If   ${minor} > {{ out.expected_state.maximum_minor_faults }}   Run Keyword And Continue On Failure

...
{% if ap.expected_state.maximum_critical_faults is defined %}
    Run Keyword If   ${critical} > {{ ap.expected_state.maximum_critical_faults }}   Run Keyword And Continue On Failure
    ...   Fail  "{{ ap_name }} has ${critical} critical faults"
{% endif %}
{% if ap.expected_state.maximum_major_faults is defined %}
    Run Keyword If   ${major} > {{ ap.expected_state.maximum_major_faults }}   Run Keyword And Continue On Failure
    ...   Fail  "{{ ap_name }} has ${major} major faults"
{% endif %}
{% if ap.expected_state.maximum_minor_faults is defined %}
    Run Keyword If   ${minor} > {{ ap.expected_state.maximum_minor_faults }}   Run Keyword And Continue On Failure
...
Verify Application Profile {{ ap_name }} Health
    ...
    Run Keyword If   ${health} < {{ ap.expected_state.minimum_health }}   Run Keyword And Continue On Failure

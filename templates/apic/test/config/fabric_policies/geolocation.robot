...
Verify Site {{ site.name }}
    ...
    Should Be Equal Value Json String   ${r}    $..geoSite.attributes.name   {{ site.name }}
    Should Be Equal Value Json String   ${r}    $..geoSite.attributes.descr   {{ site.description | default() }}
...
Verify Site {{ site.name }} Building {{ building.name }}
    ...
    Should Be Equal Value Json String   ${r}    ${building}..geoBuilding.attributes.name   {{ building.name }}
    Should Be Equal Value Json String   ${r}    ${building}..geoBuilding.attributes.descr   {{ building.description | default() }}
...
Verify Site {{ site.name }} Building {{ building.name }} Floor {{ floor.name }}
    ...
    Should Be Equal Value Json String   ${r}    ${floor}..geoFloor.attributes.name   {{ floor.name }}
    Should Be Equal Value Json String   ${r}    ${floor}..geoFloor.attributes.descr   {{ floor.description | default() }}
...
Verify Site {{ site.name }} Building {{ building.name }} Floor {{ floor.name }} Room {{ room.name }}
    ...
    Should Be Equal Value Json String   ${r}    ${room}..geoRoom.attributes.name   {{ room.name }}
    Should Be Equal Value Json String   ${r}    ${room}..geoRoom.attributes.descr   {{ room.description | default() }}
...
Verify Site {{ site.name }} Building {{ building.name }} Floor {{ floor.name }} Room {{ room.name }} Row {{ row.name }}
    ...
    Should Be Equal Value Json String   ${r}    ${row}..geoRow.attributes.name   {{ row.name }}
    Should Be Equal Value Json String   ${r}    ${row}..geoRow.attributes.descr   {{ row.description | default() }}
...
Verify Site {{ site.name }} Building {{ building.name }} Floor {{ floor.name }} Room {{ room.name }} Row {{ row.name }} Rack {{ rack.name }}
    ...
    Should Be Equal Value Json String   ${r}    ${rack}..geoRack.attributes.name   {{ rack.name }}
    Should Be Equal Value Json String   ${r}    ${rack}..geoRack.attributes.descr   {{ rack.description | default() }}
...
Verify Site {{ site.name }} Building {{ building.name }} Floor {{ floor.name }} Room {{ room.name }} Row {{ row.name }} Rack {{ rack.name }} Node {{ node }}
    ...
    Should Be Equal Value Json String   ${r}    ${node}..geoRsNodeLocation.attributes.tDn   topology/pod-{{ pod }}/node-{{ node }}

...
Verify PSU Policy {{ policy_name }}
    ...
    Should Be Equal JMESPath Json   ${r}    imdata[0].psuInstPol.attributes.name   {{ policy_name }}
    Should Be Equal JMESPath Json   ${r}    imdata[0].psuInstPol.attributes.adminRdnM   {{ admin_state }}

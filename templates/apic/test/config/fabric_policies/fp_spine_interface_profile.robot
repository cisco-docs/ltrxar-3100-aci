...
Verify Fabric Spine Interface Profile {{ spine_interface_profile_name }}
    ...
    Should Be Equal Value Json String   ${r}    $..fabricSpPortP.attributes.name   {{ spine_interface_profile_name }}
...
Verify Fabric Spine Interface Profile {{ spine_interface_profile_name }} Selector {{ spine_interface_selector_name }}
    ${sel}=   Set Variable   $..fabricSpPortP.children[?(@.fabricSFPortS.attributes.name=='{{ spine_interface_selector_name }}')]
    Should Be Equal Value Json String   ${r}    ${sel}..fabricSFPortS.attributes.name   {{ spine_interface_selector_name }}
    Should Be Equal Value Json String   ${r}    ${sel}..fabricSFPortS.attributes.descr   {{ sel.description | default() }}
...
{% set policy_group_name = sel.policy_group ~ defaults.apic.fabric_policies.spine_interface_policy_groups.name_suffix %}
    Should Be Equal Value Json String   ${r}    ${sel}..fabricRsSpPortPGrp.attributes.tDn   uni/fabric/funcprof/spportgrp-{{ policy_group_name }}
{% endif %}
...
Verify Access Spine Interface Profile {{ spine_interface_profile_name }} Selector {{ spine_interface_selector_name }} Port Block {{ block_name }}
    ${blk}=   Set Variable   $..fabricSpPortP.children[?(@.fabricSFPortS.attributes.name=='{{ spine_interface_selector_name }}')].fabricSFPortS.children[?(@.fabricPortBlk.attributes.name=='{{ block_name }}')]
    ...
    Should Be Equal Value Json String   ${r}    ${blk}..fabricPortBlk.attributes.fromCard   {{ blk.from_module | default(defaults.apic.fabric_policies.spine_interface_profiles.selectors.port_blocks.from_module) }}
    Should Be Equal Value Json String   ${r}    ${blk}..fabricPortBlk.attributes.fromPort   {{ blk.from_port }}
    Should Be Equal Value Json String   ${r}    ${blk}..fabricPortBlk.attributes.toCard   {{ blk.to_module | default(blk.from_module | default(defaults.apic.fabric_policies.spine_interface_profiles.selectors.port_blocks.from_module)) }}
...
Verify Access Spine Interface Profile {{ spine_interface_profile_name }} Selector {{ spine_interface_selector_name }} Sub-Port Block {{ sub_block_name }}
    ${blk}=   Set Variable   $..fabricSpPortP.children[?(@.fabricSFPortS.attributes.name=='{{ spine_interface_selector_name }}')].fabricSFPortS.children[?(@.fabricSubPortBlk.attributes.name=='{{ sub_block_name }}')]
    ...
    Should Be Equal Value Json String   ${r}    ${blk}..fabricSubPortBlk.attributes.fromCard   {{ sub_blk.from_module | default(defaults.apic.fabric_policies.spine_interface_profiles.selectors.sub_port_blocks.from_module) }}
    ...
    Should Be Equal Value Json String   ${r}    ${blk}..fabricSubPortBlk.attributes.toCard   {{ sub_blk.to_module | default(sub_blk.from_module | default(defaults.apic.fabric_policies.spine_interface_profiles.selectors.sub_port_blocks.from_module)) }}

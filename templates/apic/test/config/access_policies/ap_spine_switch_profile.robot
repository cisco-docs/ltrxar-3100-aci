...
Verify (Auto-Generated) Access Spine Switch Profile {{ spine_switch_profile_name }}
...
Verify (Auto-Generated) Access Spine Switch Profile {{ spine_switch_profile_name }} Interface Profile

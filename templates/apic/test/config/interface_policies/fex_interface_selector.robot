...
Verify Access FEX Interface Profile {{ fex_profile_name }} Selector {{ fex_interface_selector_name }}
    ...
    Should Be Equal Value Json String   ${r}    $..infraHPortS.attributes.name   {{ fex_interface_selector_name }}
...
{% endif %}
    ...
    Should Be Equal Value Json String   ${r}    $..attributes.description   {{ int.description }}
    Should Be Equal Value Json String   ${r}    $..attributes.node   {{ _node.id }}
    Should Be Equal Value Json String   ${r}    $..attributes.port   1

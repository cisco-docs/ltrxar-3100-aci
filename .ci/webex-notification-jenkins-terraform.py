...
* _Branch_: {branch}
* _Event_: {event}
* _Test Reports_: [APIC 4.2]({build_url}artifact/apic_tf_4.2_log.html), [APIC 5.2]({build_url}artifact/apic_tf_5.2_log.html), [APIC 6.0]({build_url}artifact/apic_tf_6.0_log.html), [NDO 4.2]({build_url}artifact/ndo_tf_4.2_log.html), [NDO 4.3]({build_url}artifact/ndo_tf_4.3_log.html), [NDO 4.4]({build_url}artifact/ndo_tf_4.4_log.html)
""".format(
